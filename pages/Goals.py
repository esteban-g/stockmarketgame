...
from utils.tree_constructor import *
from utils.tree_plotter import *
...
# plot stock tree
plot_stock_lattice(trees.stock_prices())
...
# plot options trees
if call:
    plot_option_lattice(trees.call_values())
if put:
    plot_option_lattice(trees.put_values(), 'ro-')
